  ...
  return (
    <BleedSection className="relative py-18 md:py-22">
      <div className="max-w-4xl">
        <p className="font-mono text-xs uppercase tracking-[0.22em] text-signal/85">
        ...
        <p className="mt-4 max-w-3xl text-base leading-relaxed text-body-muted md:text-lg">
      ...
      <SectionSurface className="mt-10 overflow-hidden">
        <div className="grid gap-0 lg:grid-cols-[1.05fr_1fr]">
          {CRM_WORKFLOW_VISUAL ? (
            <CloudinaryProofImage
              ...
              className="h-56 w-full border-b border-foreground/10 object-cover lg:h-full lg:min-h-[520px] lg:border-b-0 lg:border-r"
            />
          ) : (
            <div className="flex h-56 w-full items-center justify-center border-b border-foreground/10 bg-surface text-xs uppercase tracking-[0.18em] text-foreground/45 lg:h-full lg:min-h-[520px] lg:border-b-0 lg:border-r">
              Visual Pending
            </div>
          )}

          <div className="p-6 md:p-8">
            <p className="font-mono text-[0.68rem] uppercase tracking-[0.18em] text-foreground/55">
              Project type
            </p>
            <h3 className="mt-2 font-syne text-3xl leading-tight text-foreground">CRM &amp; automation</h3>

            <dl className="mt-6 space-y-5">
              <div>
                <dt className="font-mono text-[0.65rem] uppercase tracking-[0.18em] text-foreground/48">
                  What was not working
                </dt>
                <dd className="mt-1 text-sm leading-relaxed text-body-muted">
              ...
              <div>
                ...
                <dd className="mt-1 text-sm leading-relaxed text-foreground/84">
            ...
            <Link
              ...
              className="group mt-7 inline-flex items-center gap-2 text-sm text-foreground"
            >
