...
export function FoundationPathwayMini({
  ...
  return (
    ...
    >
      <div
        className="pointer-events-none absolute inset-0 bg-[radial-gradient(circle_at_50%_34%,rgba(15,217,200,0.16),transparent_34%),radial-gradient(circle_at_20%_18%,rgba(240,90,40,0.14),transparent_30%),linear-gradient(180deg,rgba(245,244,240,0.045)_0%,transparent_40%,rgba(12,12,14,0.9)_100%)]"
        aria-hidden
      />
      <div
        className="pointer-events-none absolute inset-0 opacity-[0.08] [background-image:radial-gradient(rgba(245,244,240,0.8)_0.6px,transparent_0.6px)] [background-size:4px_4px]"
        aria-hidden
      />
      <div
        className="pointer-events-none absolute inset-0 opacity-[0.15] mix-blend-screen [background-image:linear-gradient(0deg,transparent_24%,rgba(245,244,240,0.18)_25%,rgba(245,244,240,0.18)_26%,transparent_27%,transparent_74%,rgba(245,244,240,0.1)_75%,rgba(245,244,240,0.1)_76%,transparent_77%,transparent)] [background-size:100%_7px]"
        aria-hidden
      />

      <RootSystemScene trackRef={trackRef} steps={DEFAULT_STEPS} />

      <CardHeader className="relative z-20 max-w-2xl gap-0 px-5 pt-5 md:px-7 md:pt-7">
        <Badge
          variant="outline"
      ...
      <div className="pointer-events-none absolute bottom-24 left-5 right-5 z-20 grid grid-cols-2 gap-2 md:bottom-28 md:left-7 md:right-auto md:w-[25rem]">
