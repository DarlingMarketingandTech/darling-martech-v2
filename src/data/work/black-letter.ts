...
export const blackLetter: CaseStudy = {
  ...
  buyerScenario: "needs-brand-clarity-system",
  projectComplexity: "moderate",
  scopeShape: "single-system",
  evidenceType: "system-build",
  ...
  primaryOutcomeSlug: "brand-awareness",
  outcomeHeadline: "Brand identity system rebuilt with consistent standards",
  resultSummary:
