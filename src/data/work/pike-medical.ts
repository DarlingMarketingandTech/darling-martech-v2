...
export const pikeMedical: CaseStudy = {
  ...
  // TODO(phase-2-proof-taxonomy): Legacy parent proof kept for compatibility; review for removal or redirect.
  primarySimilaritySummary: "Legacy parent proof pending Phase 2 removal/redirect decision.",
  clientContextLabel: "Legacy parent proof (pending Phase 2 review)",
